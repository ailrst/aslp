...
let problematic_enc = [
  ...
  "aarch64_integer_crc";
  "aarch64_integer_logical";
  "aarch64_memory_pair_general_pre_idx";
  "aarch64_single_general_immediate_signed_pac";
  "aarch64_single_general_immediate_signed_post_idx";
  "aarch64_single_general_immediate_signed_pre_idx";
  "aarch64_single_general_immediate_signed_pre_idx";
  "aarch64_float_convert_int";
